...
#
#
# $XFree86: xc/config/cf/Imake.tmpl,v 3.87.2.1 2001/02/26 18:21:36 dawes Exp $
# ----------------------------------------------------------------------
...
# $XFree86: xc/config/cf/xf86site.def,v 3.170.2.2 2001/02/26 18:21:37 dawes Exp $
...
# operating system:  SuSE Linux [ELF] (2.4.4)
# libc:	(6.2.2)
# binutils:	(30)
...
# $XFree86: xc/config/cf/xfree86.cf,v 3.338.2.6 2001/03/15 22:58:45 dawes Exp $
...
#
#
# rules:  $XFree86: xc/config/cf/Imake.rules,v 3.86.2.1 2001/01/27 20:08:17 herrb Exp $
...
DEPFREETYPE2LIB = $(USRLIBDIR)/libfreetype.a
...
FREETYPE2DIR = $(TOP)/lib/freetype2
FREETYPE2LIBDIR = $(TOP)/lib/freetype2/lib
FREETYPE2INCDIR = $(TOP)/lib/freetype2/include/freetype2
...
Moxfm.ad::  lib/Moxfm.cpp
	$(RM) $@
	 $(CPP)  -DPIXMAPDIR=$(PIXMAPDIR) -DBITMAPDIR=$(BITMAPDIR) -DXFMRC=$(XFMRC) <lib/Moxfm.cpp | sed -e '/^#  *[0-9][0-9]*  *.*$$/d' -e '/^XCOMM$$/s//#/' -e '/^XCOMM[^a-zA-Z0-9_]/s/^XCOMM/#/' >$@
...
install::
	@if [ -d $(XFMLIBDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(XFMLIBDIR)); fi
	$(INSTALL) -c $(INSTBINFLAGS) lib/checkmail $(XFMLIBDIR)/checkmail
	@if [ -d $(XFMLIBDIR)/dot.moxfm ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(XFMLIBDIR)/dot.moxfm); fi
	...
	@if [ -d $(PIXMAPDIR) ]; then set +x; \
	else (set -x; $(MKDIRHIER) $(PIXMAPDIR)); fi
